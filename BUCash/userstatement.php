...
-->
          ...
          <form class="d-flex">
            ...
            <div>
                  ...
                  <p></p>
                <h2 style="color: white; text-align: center; font-size: 300%"> <b> Transaction with Selected User</b> </h2> 
                <p></p>
...
//                    $con=mysqli_connect("localhost", "root","") or die(mysql_error());
                    ...
                    $nid = $_SESSION['user'];
                    $snid= $_POST['SNID'];
                    $result = mysqli_query($con, "SELECT * FROM transaction WHERE NID = $nid AND ONID=$snid ORDER BY date DESC, time DESC");
                    ...
                    if($result != false){
                      ...
                      $date = $row['date'];
                            ...
                            ?>
                    <div class="card">
                        <p class="btn btn-primary btn-lg" style=" font-size:160%; border:2px solid black;"> <b>Statement no. <?php echo $i; ?> </b> </p> 
